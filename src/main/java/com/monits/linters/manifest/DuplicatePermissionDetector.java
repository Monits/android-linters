 ...
 */
package com.monits.linters.manifest;
...
public class DuplicatePermissionDetector extends Detector implements Detector.XmlScanner {
	...
	public static final Issue DUPLICATE_USES_PERMISSION = Issue.create("DuplicateUsesPermission",
			...
			Severity.WARNING, new Implementation(DuplicatePermissionDetector.class, Scope.MANIFEST_SCOPE));
	private final Map<String, Integer> permissions;

	/**
	 *  Creates a new ManifestDetector instance.
	 */
	public DuplicatePermissionDetector() {
